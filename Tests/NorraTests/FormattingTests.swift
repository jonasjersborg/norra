    ...
    func testIsPluggedIn() {
        func car(connection: String?) -> CarData {
            CarData(batteryPercentage: 50, rangeKm: 200,
                    ...
                    ownerFirstName: nil, batteryCapacityKWh: nil,
                targetChargePercentage: nil, paintName: nil, isLocked: nil, tyrePressures: [:], averageConsumption: nil,
                    odometerMeters: nil, daysToService: nil, serviceIntervalUnit: nil, distanceToServiceKm: nil,
    ...
    func testIsDriving() {
        func car(status: String, connection: String?, odometerAge: TimeInterval?,
            ...
            CarData(batteryPercentage: 50, rangeKm: 200,
                    ...
                    ownerFirstName: nil, batteryCapacityKWh: nil,
                targetChargePercentage: nil, paintName: nil, isLocked: nil, tyrePressures: [:], averageConsumption: nil,
                    odometerMeters: odometerMeters, daysToService: nil, serviceIntervalUnit: nil, distanceToServiceKm: nil,
                    serviceWarning: false, fluidWarnings: [], imageData: nil,
