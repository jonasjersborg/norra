...
//  Norra
//
//  The desktop face of Norra. It reads the snapshot the app wrote into the
...
//
//  Nothing here can make data appear: if Norra hasn't run and polled, the
...
private struct NoData: View {
    ...
    private var detail: String {
        switch problem {
        case .nothingPolledYet: return L("Open Norra to sign in")
...
struct NorraWidgetEntryView: View {
    ...
    var body: some View {
        ...
        .widgetURL(URL(string: "norra://open"))
        .widgetBackground()
    }
}
...
struct NorraCarWidget: Widget {
    var body: some WidgetConfiguration {
        StaticConfiguration(kind: "NorraCar", provider: CarProvider()) { entry in
...
@main
struct NorraWidgetBundle: WidgetBundle {
