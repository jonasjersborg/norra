...
//  NorraShared
//
//  The one channel between Norra and its widget. The app writes what it
...
public enum SharedStore {
    ...
    public static var appGroup: String? {
        let value = Bundle.main.object(forInfoDictionaryKey: "NorraAppGroup") as? String
    ...
    private static var localURL: URL? {
        ...
        let directory = URL(fileURLWithPath: home)
            .appendingPathComponent("Library/Application Support/Norra", isDirectory: true)
